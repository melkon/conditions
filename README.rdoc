...
Yeah, currently it's extending the Object class. Why? Kinda easy.
I don't want to write Conditions::handle (etc). IT'S TOO FRAKIN LONG!

CD::handle maybe. Currently the Object class is patched as soon as
Conditions are required. I'm lookin into actually check before patching if
there are other methods already in the Object class and probably not allow
